...
const selectedFunction = computed(() => {
  ...
  return functionsStore.functions.find((f) => f.name === values.function_name) || null;
});
  ...
  <section class="space-y-6 animate-in fade-in duration-500">
    ...
    <Dialog v-model:open="showCreateModal">
      <DialogContent class="max-w-2xl">
        ...
        <form id="schedule-form" class="space-y-4" @submit.prevent="onSubmit">
          <div class="space-y-2">
          ...
          <Field v-slot="{ field }" name="method">
            <div class="space-y-2">
          ...
          <Field v-slot="{ value: method }" name="method">
            <!-- Interval Options -->
            <div v-if="method === 'interval'" class="grid gap-4 md:grid-cols-2">
              <div class="space-y-2">
                <Label for="value">Value</Label>
                <Input id="value" v-model.number="valueField.value.value" type="number" min="1" />
              </div>
            ...
            <div v-if="method === 'cron'" class="space-y-2">
              ...
              <Input id="cron" v-model="cronField.value.value" placeholder="0 * * * *" />
            ...
            <div v-if="method === 'once'" class="grid gap-4 md:grid-cols-2">
              <div class="space-y-2">
                ...
                <Input id="date" v-model="dateField.value.value" type="date" />
              </div>

              <div class="space-y-2">
                <Label for="time">Time</Label>
                <Input id="time" v-model="timeField.value.value" type="time" />
              </div>
            </div>
          </Field>
          ...
          <div class="space-y-2">
            ...
            <Input id="timezone" v-model="timezoneField.value.value" placeholder="UTC" />
          </div>
